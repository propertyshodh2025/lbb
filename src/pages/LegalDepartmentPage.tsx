        ...
        <Card className="w-full max-w-md text-center bg-neutral-900 rounded-2xl glass-border">
          <CardHeader>
            <div className="flex items-center justify-between mb-4">
              ...
              <CardTitle className="text-3xl font-bold text-white/90 flex-grow">Legal Department</CardTitle>
              <div className="w-10" /> {/* Spacer */}
            </div>
            <CardDescription className="text-lg text-white/70">
              Ensuring compliance and protecting our interests.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <Scale className="h-24 w-24 text-lime-400 mx-auto" />
